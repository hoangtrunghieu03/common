...
import { onLoadNotification } from '../store/actions/notification.action';
import Guid from '../../../../at-common/model/Guid';
...
export default class WebSocketClientHelper {
    ...
    private userManager: StaffsManager;
    ...
    private disable() {
        console.log('Clear WebSocket Client');
    ...
    private OnMessage(data: MessageEvent) {
        ...
        switch (message.type) {
            ...
            case "notification_Reload":
                ...
                // call notification/notificationme
