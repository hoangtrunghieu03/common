...
@Component({
  selector: 'app-implant-medical-record',
  templateUrl: './implant-medical-record.component.html',
  styleUrls: ['./implant-medical-record.component.scss'],
  providers: [BracesDetailComponent]
})
export class ImplantMedicalRecordComponent implements OnInit {
