...
export default class BaseHelper<T extends BaseObj> extends BaseObj {
    ...
    public acessAllStore: boolean=true;
    ...
    public onBeforeSearch<T>(search: any) {
       /* if (this.user != null && this.user.hasOwnProperty("storeId") && this.isNotBlank(this.user.storeId)) {
            if (search != null && !search.hasOwnProperty("storeId")) {
                search['storeId'] = this.objectID(this.user.storeId);
            }
        }*/
        //return null;
    }
    ...
    public onBeforeSave<T extends BaseEntity<T>>(object: T): string {
       /* if (this.user != null && this.user.hasOwnProperty("storeId")) {
            if (object != null && object.hasOwnProperty("storeId")) {
                if(this.isNotBlank(object['storeId'])){
                    object['storeId'] = this.objectID(object['storeId']);
                } else if(this.isNotBlank(this.user.storeId)) {
                    object['storeId'] = this.objectID(this.user.storeId);
                }
            }
        }*/
        ...
        let promise = new Promise((resolve, reject) => {
            setTimeout(() => {
              ...
              /*  if (this.user != null && this.user.hasOwnProperty("storeId")) {
                ...
                if (this.user != null && this.user.hasOwnProperty("_id")) {
                    if (object != null && object.hasOwnProperty("updateByUserId")) {
                        object['updateByUserId'] = this.user._id;
                    }
                }
                if (object.hasOwnProperty("paymentDate")) {
                    object["paymentDate"] = IsoDateHelper.convertIsoDate(object["paymentDate"]);
                }
                ...
                if (object.hasOwnProperty("examinationDate")) {
                    object["examinationDate"] = IsoDateHelper.convertIsoDate(object["examinationDate"]);
                }
                if (object.hasOwnProperty("birthday")) {
                    object["birthday"] = IsoDateHelper.convertToDate(object["birthday"]);
                } 
                if (object.hasOwnProperty("scheduleTime")) {
                    object["scheduleTime"] = IsoDateHelper.convertIsoDate(object["scheduleTime"]);
                }
                // if (object.hasOwnProperty("mfgDate")) {
                //     object["mfgDate"] = IsoDateHelper.convertToDate(object["mfgDate"]);
                // }
                // if (object.hasOwnProperty("expDate")) {
                //     object["expDate"] = IsoDateHelper.convertToDate(object["expDate"]);
                // }              
        ...
        let promise = new Promise((resolve, reject) => {
            setTimeout(() => {
               ...
               /* if (this.user != null && this.user.hasOwnProperty("storeId")) {
                ...
                if (object.hasOwnProperty("examinationDate")) {
                    object["examinationDate"] = IsoDateHelper.getISODateByTimezone('Asia/Ho_Chi_Minh');
                }
                if (object.hasOwnProperty("birthday")) {
                    object["birthday"] = IsoDateHelper.convertToDate(object["birthday"]);
                }
