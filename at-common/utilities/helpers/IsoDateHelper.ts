export class IsoDateHelper {
    ...
    */
    ...
    /**
         * Get start time of current iso date
         */
     public static convertToDate(date: Date | string): Date {
        let result;
    ...
    public static getISODateByTimezone(timeZone: string, dateTime: Date = new Date()): Date {
        ...
        if (timeZone) {
            let currentTime = dateTime,
                options = { timeZone: timeZone, year: 'numeric', month: 'numeric', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false } as const,
     ...
     * @param timeZone 
     */
     public static getISODateByTimezoneOnlyDate(timeZone: string, dateTime: Date = new Date()): Date {
        let currentTime = dateTime;
        if (timeZone) {
            let currentTime = dateTime,
                options = { timeZone: timeZone, year: 'numeric', month: 'numeric', day: 'numeric', hour: '2-digit', minute: '2-digit', second: '2-digit', hour12: false } as const,
