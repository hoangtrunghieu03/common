        ...
        if (token == null) {
            try {
                if (localStorage.getItem('id_token')) {
                    ...
                    token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..bynoPZ_HWwLBD1NcOPjW_GeMQV7pqld6XyJ6CAhAY9Q';
                }
            } catch (error) {
