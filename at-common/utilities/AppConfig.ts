...
class AppConfig {
  ...
  public AMAZON_S3_ENDPIONT = "AMAZON_S3_ENDPIONT";
  public AMAZON_S3_HOST = "AMAZON_S3_HOST";
  public AMAZON_S3_UPLOAD_FOLDER = "AMAZON_S3_UPLOAD_FOLDER";
  /**STATIC_UPLOAD_FOLDER */
  public STATIC_UPLOAD_FOLDER = "STATIC_UPLOAD_FOLDER";

   /**CRON JOB SENT NOTIFICATION */
   public CRON_NOTIFICATION = "CRON_NOTIFICATION";
  ...
  private LoadValues(obj: any, configValues: any) {
    ...
    obj[this.AMAZON_S3_ENDPIONT] = configValues[this.AMAZON_S3_ENDPIONT];
    obj[this.AMAZON_S3_UPLOAD_FOLDER] = configValues[this.AMAZON_S3_UPLOAD_FOLDER];
    obj[this.AMAZON_S3_HOST] = configValues[this.AMAZON_S3_HOST]
    /** UPLOAD FOLDER */
    obj[this.STATIC_UPLOAD_FOLDER] = configValues[this.STATIC_UPLOAD_FOLDER];
     /** CRON_NOTIFICATION  */
     obj[this.CRON_NOTIFICATION] = configValues[this.CRON_NOTIFICATION];
  }
