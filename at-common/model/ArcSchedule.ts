...
/** Lịch hẹn */
export default class ArcSchedule extends BaseEntity<ArcSchedule> {
  ...
  deliveryDate: Date = null;// thời gian hẹn
  ...
  public assign(obj: any) {
    ...
    this.deliveryDate = obj.hasOwnProperty("deliveryDate") ? obj.deliveryDate : this.deliveryDate;
  ...
  public static newInstance(): ArcSchedule {
    let result = new ArcSchedule();
    return result;
  }
}